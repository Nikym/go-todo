...
// MockEntryService is an autogenerated mock type for the EntryService type
type MockEntryService struct {
	mock.Mock
}

// Create provides a mock function with given fields: title, description
func (_m *MockEntryService) Create(title string, description string) (*domain.Entry, error) {
...
func (_m *MockEntryService) Delete(id string) error {
	ret := _m.Called(id)
...
func (_m *MockEntryService) Get(id string) (*domain.Entry, error) {
	ret := _m.Called(id)
...
func (_m *MockEntryService) Update(id string, entry *domain.Entry) error {
